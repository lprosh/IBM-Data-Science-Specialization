...
1. Какой инструмент используют большинство разработчиков Python?

   - [x] Jupyter Notebook / JupyterLab

   - [ ] RStudio

2. Jupyter Notebook / JupyterLab поддерживают разработку в R.
   
   - [x] Правда
   
   - [ ] Ложь

3. Какой инструмент объединяет документацию, исходный код и визуализацию данных в единый документ?
...
4. Какая команда используется для установки пакетов в R?
   
   - [ ] package("package name")

   - [s] install.packages("package name")

   - [ ] install.package("package name")

   - [ ] install("package name")

5. Ядро Jupyter Notebook должно быть установлено на локальном сервере.
   
   - [ ] Правда
   
   - [x] Ложь

6. RStudio поддерживает разработку на Python.
